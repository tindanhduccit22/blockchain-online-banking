...
contract VaultManager is Ownable, Pausable {
    ...
    event ReservedInterestUpdated(uint256 newTotal);
    ...
    function updateReservedInterest(uint256 newTotal) external onlySavingCore {
        reservedInterest = newTotal;
        emit ReservedInterestUpdated(newTotal);
    }
